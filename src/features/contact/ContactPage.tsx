  ...
  return (
    <main className="relative">
      <section className="md:bg-[url('/images/contact.jfif')] bg-[url('/images/resp-contact.jfif')]  backgroundImage w-full min-h-[300px] md:min-h-[800px]   bg-black/60 relative">
        ...
        <article className="text-center text-white p-5 relative">
      ...
      <div className="mt-0 md:mt-20 w-full mx-auto h-full flex bg-button-blue md:bg-transparent justify-center items-center md:absolute md:top-0">
        <ContactForm />
      </div>
    </main>
  );
